...
const AuthList = () => {
  ...
  const fetchAuths = async () => {
    try {
      const response = await axios.get('https://www.panel.efe-travel.com/api/auths/');
  ...
  const handleAddAuth = async () => {
    try {
      const response = await axios.post('https://www.panel.efe-travel.com/api/auths/website', { username, email, password });
  ...
  const handleDeleteAuth = async (id) => {
    try {
      await axios.delete(`https://www.panel.efe-travel.com/api/auths/${id}`);

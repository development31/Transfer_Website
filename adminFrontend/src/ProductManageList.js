...
const ProductManageList = () => {
  ...
  const fetchProductManageData = async () => {
    try {
      const response = await axios.get('https://www.panel.efe-travel.com/api/ProductManageData')
  ...
  const handleAddProductManage = async () => {
    ...
    try {
      const response = await axios.post(
        'https://www.panel.efe-travel.com/api/ProductManageData/pname',
        formData,
        {
          headers: {
  ...
  const handleDeleteProductManage = async (id) => {
    try {
      await axios.delete(`https://www.panel.efe-travel.com/api/ProductManageData/${id}`)
  ...
  const handleUpdateProductManage = async () => {
    ...
    try {
      const response = await axios.put(
        `https://www.panel.efe-travel.com/api/ProductManageData/${currentProductId}`,
        formData,
        {
          headers: {
            'Content-Type': 'multipart/form-data',

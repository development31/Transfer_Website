...
const ProductOrder = () => {
  ...
  const fetchOrders = async () => {
    try {
      const response = await axios.get('https://www.panel.efe-travel.com/api/productOrders');
  ...
  const searchOrders = async () => {
    try {
      const response = await axios.get(`https://www.panel.efe-travel.com/api/productOrders?buyerName=${searchBuyerName}`);
      setOrders(response.data);
    } catch (error) {
  ...
  const deleteOrder = async (id) => {
    try {
      await axios.delete(`https://www.panel.efe-travel.com/api/productOrders/${id}`);
  ...
  const updateOrder = async () => {
    ...
    try {
      const response = await axios.put(
        `https://www.panel.efe-travel.com/api/productOrders/${currentOrderId}`,
        updatedOrder
      );
      setOrders(
        orders.map((order) =>

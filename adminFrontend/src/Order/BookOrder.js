...
const BookOrder = () => {
  ...
  const fetchOrders = async () => {
    try {
      const response = await axios.post('https://www.panel.efe-travel.com/api/Booking/',{searchName});
  ...
  const deleteOrder = async (id) => {
    try {
      await axios.delete(`https://www.panel.efe-travel.com/api/Booking/${id}`);
  ...
  const updateOrder = async () => {
    ...
    try {
      const response = await axios.put(
        `https://www.panel.efe-travel.com/api/Booking/${currentOrderId}`,
        updatedOrder
      );
      setOrders(
        orders.map(order =>

...
const StaticContentManageList = () => {
  ...
  const handleAddStaticContent = async () => {
    try {
      const response = await axios.post('https://www.panel.efe-travel.com/api/StaticContentManageData/StaticContent', { policy, termsandconditions });
  ...
  const handleUpdateStaticContent = async () => {
    try {
      ...
      const response = await axios.put(`https://www.panel.efe-travel.com/api/StaticContentManageData/${id}`, { policy, termsandconditions });
